...
class PopupProps<T> {
  ...
  final HcDropdownSearchPopupItemBuilder<T>? itemBuilder;
  ...
  const PopupProps.modalBottomSheet({
    ...
    this.constraints = const BoxConstraints(maxHeight: 500),
    this.interceptCallBacks = false,
  })  : mode = Mode.modalBottomSheet,
        menuProps = const MenuProps(),
        dialogProps = const DialogProps(),
        bottomSheetProps = const BottomSheetProps();
}

class HcPopupPropsMultiSelection<T> extends PopupProps<T> {
  ...
  final HcDropdownSearchPopupItemBuilder<T>? selectionWidget;
  ...
  const HcPopupPropsMultiSelection._({
  ...
  const HcPopupPropsMultiSelection.modalBottomSheet({
    super.title,
    super.isFilterOnline,
    super.fit = FlexFit.tight,
    super.itemBuilder,
  ...
  HcPopupPropsMultiSelection.from(PopupProps<T> popupProps)
      : this._(
