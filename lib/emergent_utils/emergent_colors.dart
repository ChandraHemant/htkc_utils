...
import 'package:htkc_utils/emergent_utils/widget/emergent_container.dart';
...
class EmergentColors {
  ...
  static Color hcWhiteColor(Color color, {required double intensity}) {
    // intensity act on opacity;
    return _applyPercentageOnOpacity(
      maxColor: color,
      percent: intensity,
  ...
  static Color hcDarkColor(Color color, {required double intensity}) {
    // intensity act on opacity;
    return _applyPercentageOnOpacity(
      maxColor: color,
      percent: intensity,
