...
class EmergentEmptyTextPainter extends BoxPainter {
  EmergentEmptyTextPainter({required VoidCallback onChanged})
      : super(onChanged);
...
class EmergentDecorationTextPainter extends BoxPainter {
  final EmergentStyle style;
  final String text;
  final TextStyle textStyle;
  final TextAlign textAlign;

  final EmergentPainterCache _cache;
