...
///
/// EmergentProgress is determinate.
///
...
///  ```
///
class EmergentProgress extends StatefulWidget {
...
class EmergentProgressState extends State<EmergentProgress>
  ...
  @override
  void didUpdateWidget(EmergentProgress oldWidget) {
    ...
    return SizedBox(
      ...
      child: FractionallySizedBox(
        ...
        child: Emergent(
          ...
          style: EmergentStyle(
            boxShape: EmergentBoxShape.roundRect(widget.style.borderRadius),
...
/// A widget that shows progress along a line.
///
/// EmergentProgressIndeterminate is indeterminate.
///
...
///  ```
///
class EmergentProgressIndeterminate extends StatefulWidget {
  final double height;
  final ProgressStyle style;
  final Duration duration;
  final bool reverse;
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is EmergentProgressIndeterminate &&
          runtimeType == other.runtimeType &&
          height == other.height &&
          style == other.style &&
