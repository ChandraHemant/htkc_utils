...
class HcDropdownSuggestionsFormField<T> extends StatefulWidget {
  ...
  const HcDropdownSuggestionsFormField({
    key,
  ...
  @override
  HcDropdownSuggestionsFormFieldState<T> createState() =>
      HcDropdownSuggestionsFormFieldState<T>();
}
...
class HcDropdownSuggestionsFormFieldState<T>
    extends State<HcDropdownSuggestionsFormField<T>> {
...
class HcDebounce {
  ...
  HcDebounce({required this.milliseconds});
