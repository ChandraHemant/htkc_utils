...
///
/// In radial charts a [HcCircularSegmentEntry] corresponds to an arc segment of
...
class HcCircularSegmentEntry {
  const HcCircularSegmentEntry(this.value, this.color, {this.rankKey});
...
///
/// Each [HcCircularStackEntry] corresponds to a complete circle in the chart.
...
class HcCircularStackEntry {
  const HcCircularStackEntry(this.entries, {this.rankKey});

  /// List of [HcCircularSegmentEntry]s that make up this stack.
  final List<HcCircularSegmentEntry> entries;
