...
import 'package:htkc_utils/hc_utils/otp/hc_otp_field_style.dart';

class HcOTPTextField extends StatefulWidget {
  ...
  @override
  HcOTPTextFieldState createState() => HcOTPTextFieldState();
}

class HcOTPTextFieldState extends State<HcOTPTextField> {
...
class OtpFieldController {
  late HcOTPTextFieldState _otpTextFieldState;

  void setOtpTextFieldState(HcOTPTextFieldState state) {
