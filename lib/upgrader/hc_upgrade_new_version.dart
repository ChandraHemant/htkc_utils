...
class HcUpgradeVersion {
  ...
  showAlertIfNecessary({required BuildContext context}) async {
    final HcNewVersionStatus? versionStatus = await getHcNewVersionStatus();
  ...
  /// way.
  Future<HcNewVersionStatus?> getHcNewVersionStatus() async {
  ...
  /// JSON document.
  Future<HcNewVersionStatus?> _getiOSStoreVersion(PackageInfo packageInfo) async {
  ...
  Future<HcNewVersionStatus?> _getAndroidStoreVersion(
  ...
  void showUpdateDialog({
    ...
    required HcNewVersionStatus versionStatus,
