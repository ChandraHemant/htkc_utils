...
class _HcAdvanceExampleState extends State<HcAdvanceExample> {
  ...
  Widget build(BuildContext context) {
    ...
    widgets = {
      "Single dialog": HcSearchableDropdown.single(
        items: items,
        value: selectedValue,
        hint: "Select one",
      ...
      "Single done button dialog": HcSearchableDropdown.single(
        items: items,
        value: selectedValue,
        hint: "Select one",
        searchHint: "Select one",
      ...
      "Multi custom display dialog": HcSearchableDropdown.multiple(
        items: items,
        selectedItems: selectedItems,
        hint: Padding(
          padding: const EdgeInsets.all(12.0),
      ...
      "Multi select 3 dialog": HcSearchableDropdown.multiple(
        items: items,
        selectedItems: selectedItems,
        hint: "Select 3 items",
        searchHint: "Select 3",
      ...
      "Single menu": HcSearchableDropdown.single(
        items: items,
        value: selectedValue,
        hint: "Select one",
        searchHint: null,
      ...
      "Multi menu": HcSearchableDropdown.multiple(
        items: items,
        selectedItems: selectedItems,
        hint: "Select any",
        searchHint: "",
      ...
      "Multi menu select all/none": HcSearchableDropdown.multiple(
        items: items,
        selectedItems: selectedItems,
        hint: "Select any",
        searchHint: "Select any",
      ...
      "Single dialog custom keyboard": HcSearchableDropdown.single(
      ...
      "Single dialog object": HcSearchableDropdown.single(
      ...
      "Single dialog overflow": HcSearchableDropdown.single(
        items: [
          DropdownMenuItem(
            child: Text(
      ...
      "Single dialog readOnly": HcSearchableDropdown.single(
        items: [
          DropdownMenuItem(
            child: Text("one item"),
            value: "one item",
      ...
      "Single dialog disabled": HcSearchableDropdown.single(
        items: [
          DropdownMenuItem(
            child: Text("one item"),
            value: "one item",
      ...
      "Historical example": HcSearchableDropdown(
        items: items,
        value: selectedValue,
