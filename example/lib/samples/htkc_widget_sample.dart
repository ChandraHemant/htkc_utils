    ...
    return Row(children: <Widget>[
      ...
      EmergentSwitch(
        ...
        style: EmergentSwitchStyle(
          thumbShape: EmergentShape.concave, // concave or flat with elevation
        ),
        onChanged: (value) {
          setState(() {
      ...
      EmergentSwitch(
        ...
        style: EmergentSwitchStyle(
          thumbShape: EmergentShape.flat, // concave or flat with elevation
        ),
        onChanged: (value) {
          setState(() {
      ...
      EmergentSwitch(
        ...
        style: EmergentSwitchStyle(
          thumbShape: EmergentShape.convex,
        ),
        onChanged: (value) {
          setState(() {
  ...
  Widget build(BuildContext context) {
    return EmergentTheme(
      ...
      darkTheme: EmergentThemeData(
        baseColor: EmergentColors.darkBackground,
        accentColor: EmergentColors.darkAccent,
        lightSource: LightSource.topLeft,
        depth: 6,
        intensity: 0.3,
      ),
      theme: EmergentThemeData(
        baseColor: EmergentColors.background,
        lightSource: LightSource.topLeft,
        depth: 10,
        intensity: 0.5,
      ),
