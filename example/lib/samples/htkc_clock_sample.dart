        ...
        children: <Widget>[
          ...
          Text(
            ...
            style: TextStyle(
              ...
              fontSize: 16,
              color: EmergentTheme.variantColor(context),
            ),
          ),
          SizedBox(height: 20),
          EmergentSelector(),
...
class EmergentClock extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return AspectRatio(
      aspectRatio: 1,
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      _buildLine(
                        ...
                        angle: 0,
                        width: 70,
                        color: EmergentTheme.accentColor(context),
                      ),
                      _buildLine(
                        context: context,
                        angle: 0.9,
...
class EmergentSelector extends StatelessWidget {
