...
class EmergentAccessibility extends StatefulWidget {
  @override
  createState() => _EmergentAccessibilityState();
}

class _EmergentAccessibilityState extends State<EmergentAccessibility> {
  @override
...
class __PageState extends State<_Page> {
  ...
  void didChangeDependencies() {
    ...
    borderColor = EmergentTheme.currentTheme(context).borderColor;
    borderWidth = EmergentTheme.currentTheme(context).borderWidth;
  }
